disease_dic = {
    'Apple___Apple_scab': """ <b>Crop</b>: Apple <br/><b>Disease:</b> Apple Scab<br/>
        <br/><b>Cause of disease:</b>

        <br/> 1. Apple scab overwinters primarily in fallen leaves and in the soil. Disease development is favored by wet, cool weather that generally occurs in spring and early summer.
        ...
        <br/><br/><b> How to prevent/cure the disease</b> 
    ...
    'Apple___Black_rot': """ <b>Crop</b>: Apple <br/><b>Disease:</b> Black Rot<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Apple___Cedar_apple_rust': """ <b>Crop</b>: Apple <br/><b>Disease:</b> Cedar Apple Rust<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Apple___healthy': """ <b>Crop</b>: Apple <br/><b>Disease:</b> No disease<br/>
    ...
    'Blueberry___healthy': """ <b>Crop</b>: Blueberry <br/><b>Disease:</b> No disease<br/>
    ...
    'Cherry_(including_sour)___Powdery_mildew': """ <b>Crop</b>: Cherry <br/><b>Disease:</b> Powdery Mildew<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Cherry_(including_sour)___healthy': """ <b>Crop</b>: Cherry <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot': """ <b>Crop</b>: Corn <br/><b>Disease:</b> Grey Leaf Spot<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Corn_(maize)___Common_rust_': """ <b>Crop</b>: Corn(maize) <br/><b>Disease:</b> Common Rust<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Corn_(maize)___Northern_Leaf_Blight': """ <b>Crop</b>: Corn(maize) <br/><b>Disease:</b> Northern Leaf Blight
        <br/>
            <br/><b>Cause of disease:</b>
    ...
    'Grape___Black_rot': """ <b>Crop</b>: Grape <br/><b>Disease:</b> Black Rot<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Corn_(maize)___healthy': """ <b>Crop</b>: Corn(maize) <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Grape___Esca_(Black_Measles)': """ <b>Crop</b>: Grape <br/><b>Disease:</b> Black Measles<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """ <b>Crop</b>: Grape <br/><b>Disease:</b> Leaf Blight<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Grape___healthy': """ <b>Crop</b>: Grape <br/><b>Disease:</b> No disease<br/>
    ...
    'Orange___Haunglongbing_(Citrus_greening)': """ <b>Crop</b>: Orange <br/><b>Disease:</b> Citrus Greening<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Peach___Bacterial_spot': """ <b>Crop</b>: Peach <br/><b>Disease:</b> Bacterial Spot<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Pepper,_bell___Bacterial_spot': """ <b>Crop</b>: Pepper <br/><b>Disease:</b> Bacterial Spot<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Peach___healthy': """ <b>Crop</b>: Peach <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Pepper,_bell___healthy': """ <b>Crop</b>: Pepper <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato___healthy': """ <b>Crop</b>: Potato <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Raspberry___healthy': """ <b>Crop</b>: Raspberry <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Soybean___healthy': """ <b>Crop</b>: Soyabean <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Strawberry___healthy': """ <b>Crop</b>: Strawberry <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Tomato___healthy': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato___Early_blight': """ <b>Crop</b>: Potato <br/><b>Disease:</b> Early Blight<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Potato___Late_blight': """ <b>Crop</b>: Potato <br/><b>Disease:</b> Late Blight<br/>
    ...
    'Squash___Powdery_mildew': """ <b>Crop</b>: Squash <br/><b>Disease:</b> Powdery mildew<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Strawberry___Leaf_scorch': """ <b>Crop</b>: Strawberry <br/><b>Disease:</b> Leaf Scorch<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Tomato___Bacterial_spot': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Bacterial Spot<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Tomato___Early_blight': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Early Blight<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Tomato___Late_blight': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Late Blight<br/>
    ...
    'Tomato___Leaf_Mold': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Leaf Mold<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Tomato___Septoria_leaf_spot': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Leaf Spot<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Two-spotted spider mite<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Tomato___Target_Spo': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Target Spot<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Yellow Leaf Curl Virus<br/>
            <br/><b>Cause of disease:</b>
    ...
    'Tomato___Tomato_mosaic_virus': """ <b>Crop</b>: Tomato <br/><b>Disease:</b> Mosaic Virus<br/>
            <br/><b>Cause of disease:</b>
