...
<head>
  ...
  <body class="bg-white" id="top" onload="myFunction()">
      ...
      <div class="container">
        <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
          <li class="nav-item dropdown">
            <a href="index.php" class="navbar-brand mr-lg-4 text-white">
        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
		  ...
		  <!-- <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> -->
              <a href="farmer/fregister.php" class="nav-link">    
                  <span class="text-white nav-link-inner--text"
    ...
    <div class="wrapper">
    <header class="jumbotron" style="background-image: url('farmer/static/images/farm_background.jpg'); background-size: cover; background-position: center;">
        <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">Farmers can get recommendations for crop n fertilizer and even 
            predict the weather and get the news related to agriculture. </p>
